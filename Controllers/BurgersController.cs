...
namespace DE_Ejercicio1CF.Controllers
{
    public class BurgersController : Controller
    {
        private readonly DE_Ejercicio1CFContext _context;

        public BurgersController(DE_Ejercicio1CFContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'DE_Ejercicio1CFContext.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DE_Ejercicio1CFContext.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
